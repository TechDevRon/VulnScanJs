...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--matching', default=False, action='store_true', help='Enable if you have regex in the wordlist file the program will compile if opinion is used.')
